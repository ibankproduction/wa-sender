...
<head>
    ...
    <meta name="description" content="WaSender Lite">
    <meta name="author" content="MCP">

    <title>WaSender Lite - Dashboard</title>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5g
    PSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" />
        ...
        <ul class="navbar-nav ss sidebar " id="accordionSidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="kontak.php">
                    <i class="fas fa-fw fa-phone-alt"></i>
                    <span> Kontak</span> <span class="badge badge-success" style="font-size:50%">NEW</span></a>
            </li>
